        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-col lg:flex-row">
            ...
            <div onClick={()=>setMethod('cod')} className="flex items-center gap-3 border p-2 px-3 cursor-pointer">
              ...
              <p className="text-gray-500 test-sm font-medium mx-4">CASH ON DELIVERY</p>
            </div>
          </div>
          <div className="w-full text-end mt-8">
              <button onClick={()=>navigate('/orders')} className="w-full border bg-black text-white text-sm my-8 px-8 py-3 hover:bg-white hover:text-black cursor-pointer">PLACE ORDER</button>
          </div>
        </div>
      </div>
    </div>
